...
O projeto foi dividido em três subprojetos, que são: Controle e Monitoramento,
Projeto Estrutural e Alimentação e Movimentação. Dentro dos subprojetos a equipe
...
\textbf{Controle e Monitoramento:} responsável pela aquisição de sinais vitais do paciente,
...
\textbf{Projeto de Estruturas:} responsável pelo projeto estrutural da cadeira, testes
do sistema estrutural, simulações e construção da cadeira.
\\Responsáveis: Nivaldo Lopo, Rafael Amado, Lucas Oliveira.

\textbf{Movimentação e Alimentação:} responsável por dimensionamento dos motores utilizados,
